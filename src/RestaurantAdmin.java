 ...
 * I also offered it in my zip.
 * Named: mysql-connector-java-8.0.22.jar
...
public class RestaurantAdmin {
    ...
    static final String url = "jdbc:mysql://localhost:3306/restaurant?useSSL=false&" +
            "allowPublicKeyRetrieval=true&serverTimezone=EST";
    static final String usernamestring = "root";
    static final String passwordstring = "toor";
